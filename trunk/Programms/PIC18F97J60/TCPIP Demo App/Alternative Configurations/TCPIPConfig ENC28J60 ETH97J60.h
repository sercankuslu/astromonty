 ...
 */
#define USE_PROTOCOL_CLIENT             // используем протокол в режиме клиента
 ...
 */
#define MY_DEFAULT_HOST_NAME			"ACCONTORL"
#define MY_DEFAULT_SERVER_NAME			"ASTROMONTY"
...
#define MY_DEFAULT_MAC_BYTE5            (0x11)	// internal factory programmed MAC
 ...
 */
	...
	#define END_OF_TCP_SOCKET_TYPES
		...
		} TCPSocketInitializer[] = 
		{
			...
			//{TCP_PURPOSE_BERKELEY_SERVER, TCP_ETH_RAM, 125, 20},
			//{TCP_PURPOSE_BERKELEY_SERVER, TCP_ETH_RAM, 125, 20},
			//{TCP_PURPOSE_BERKELEY_SERVER, TCP_ETH_RAM, 125, 20},
