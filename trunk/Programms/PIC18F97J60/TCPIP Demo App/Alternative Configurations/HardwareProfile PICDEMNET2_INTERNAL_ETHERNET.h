...
#define LED2_TRIS			(TRISBbits.TRISB5)	// Ref D6
#define LED2_IO				(LATBbits.LATB5)
#define LED3_TRIS			(TRISDbits.TRISD0)	// Ref D5
#define LED3_IO				(LATDbits.LATD0)
#define LED4_TRIS			(TRISDbits.TRISD1)	// Ref D4
#define LED4_IO				(LATDbits.LATD1)
#define LED5_TRIS			(TRISDbits.TRISD2)	// Ref D3
#define LED5_IO				(LATDbits.LATD2)
#define LED6_TRIS			(TRISAbits.TRISA0)   // Ref D2
#define LED6_IO				(LATAbits.LATA0)
#define LED7_TRIS			(TRISAbits.TRISA1)	// Ref D1
#define LED7_IO				(LATAbits.LATA1)
#define LED_GET()			
#define LED_PUT(a)			

// Momentary push buttons
#define BUTTON0_TRIS		(TRISBbits.TRISB1)	// Ref S5
#define	BUTTON0_IO			(PORTBbits.RB1)
#define BUTTON1_TRIS		(TRISBbits.TRISB2)	// Ref S4
#define	BUTTON1_IO			(PORTBbits.RB2)
#define BUTTON2_TRIS		(TRISBbits.TRISB3)	// Ref S3
#define	BUTTON2_IO			(PORTBbits.RB3)
#define BUTTON3_TRIS		(TRISBbits.TRISB4)	// Ref S2
