...
//------------------------------------------------------------------------------------------------
{
    ...
    while(!BufferFull){
        ...
        case SEND_DATA:
            ...
            break;
        case SEND_FINAL_PART: // все записано в буфер. осталось только помен€ть режим DMA
        ...
        case RECEIVE_DATA:
            ...
            break;
        case RECEIVE_FINAL_PART: // все записано в буфер. осталось только помен€ть режим DMA
