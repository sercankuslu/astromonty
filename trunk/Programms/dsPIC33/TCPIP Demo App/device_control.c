...
//------------------------------------------------------------------------------------------------
{
    switch(id){
        case ID_OC1:
            ...
            IFS0bits.OC1IF = 0;                 // ÑÐ±Ñ€Ð¾ÑÐ¸Ñ‚ÑŒ Ñ„Ð»Ð°Ð³ Ð¿Ñ€ÐµÑ€Ñ‹Ð²Ð°Ð½Ð¸Ñ
        ...
        case ID_OC2:
            ...
            IFS0bits.OC2IF = 0;                 // ÑÐ±Ñ€Ð¾ÑÐ¸Ñ‚ÑŒ Ñ„Ð»Ð°Ð³ Ð¿Ñ€ÐµÑ€Ñ‹Ð²Ð°Ð½Ð¸Ñ
        ...
        case ID_OC3:
            ...
            IFS1bits.OC3IF = 0;                 // ÑÐ±Ñ€Ð¾ÑÐ¸Ñ‚ÑŒ Ñ„Ð»Ð°Ð³ Ð¿Ñ€ÐµÑ€Ñ‹Ð²Ð°Ð½Ð¸Ñ
        ...
        case ID_OC4:
            ...
            IFS1bits.OC4IF = 0;                 // ÑÐ±Ñ€Ð¾ÑÐ¸Ñ‚ÑŒ Ñ„Ð»Ð°Ð³ Ð¿Ñ€ÐµÑ€Ñ‹Ð²Ð°Ð½Ð¸Ñ
        ...
        case ID_OC5:
            ...
            IFS2bits.OC5IF = 0;                 // ÑÐ±Ñ€Ð¾ÑÐ¸Ñ‚ÑŒ Ñ„Ð»Ð°Ð³ Ð¿Ñ€ÐµÑ€Ñ‹Ð²Ð°Ð½Ð¸Ñ
        ...
        case ID_OC6:
            ...
            IFS2bits.OC6IF = 0;                 // ÑÐ±Ñ€Ð¾ÑÐ¸Ñ‚ÑŒ Ñ„Ð»Ð°Ð³ Ð¿Ñ€ÐµÑ€Ñ‹Ð²Ð°Ð½Ð¸Ñ
        ...
        case ID_OC7:
            ...
            IFS2bits.OC7IF = 0;                 // ÑÐ±Ñ€Ð¾ÑÐ¸Ñ‚ÑŒ Ñ„Ð»Ð°Ð³ Ð¿Ñ€ÐµÑ€Ñ‹Ð²Ð°Ð½Ð¸Ñ
        ...
        case ID_OC8:
            ...
            IFS2bits.OC8IF = 0;                 // ÑÐ±Ñ€Ð¾ÑÐ¸Ñ‚ÑŒ Ñ„Ð»Ð°Ð³ Ð¿Ñ€ÐµÑ€Ñ‹Ð²Ð°Ð½Ð¸Ñ
...
//------------------------------------------------------------------------------------------------
{
    ...
    while(!BufferFull){
        ...
        case SEND_DATA:
            ...
            break;
        case FINAL_PART: // âñå çàïèñàíî â áóôåð. îñòàëîñü òîëüêî ïîìåíÿòü ðåæèì DMA
...
//------------------------------------------------------------------------------------------------
// ïîëó÷åíèå äàííûõ ÷åðåç SPI
// ðåãóëÿðíàÿ îòïðàâêà áåç áëîêèðîâîê è âûáîðà óñòðîéñòâà
//------------------------------------------------------------------------------------------------
...
{
    BYTE TmpInt;
    // óñòàíîâêà òåêóùåãî ïðèîðèòåòà CPU íà 4
    ...
    if(DataLen & 0x0001){
        // Åñëè äëèííà íå÷åòíàÿ, òî îòïðàâèì 1 áàéò îòäåëüíî â êîíöå
        DataLen -= 1;
    }
...
// Initialize Timer2
    ...
    // îñâîáîæäåíèå óñòðîéñòâà
    DeviceRelease();
    // âîññòàíîâëåíèå ïðèîðèòåòà CPU
