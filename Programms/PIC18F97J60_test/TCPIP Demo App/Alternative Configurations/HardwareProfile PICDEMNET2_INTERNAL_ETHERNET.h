...
// LEDs
#define LED0_TRIS			(TRISGbits.TRISG4)	// Ref D8
#define LED0_IO				(LATGbits.LATG4)
#define LED1_TRIS			(TRISGbits.TRISG4)	// Ref D7
#define LED1_IO				(LATGbits.LATG4)
#define LED2_TRIS			(TRISGbits.TRISG4)	// Ref D6
#define LED2_IO				(LATGbits.LATG4)
#define LED3_TRIS			(TRISGbits.TRISG4)	// Ref D5
#define LED3_IO				(LATGbits.LATG4)
#define LED4_TRIS			(TRISGbits.TRISG4)	// Ref D4
#define LED4_IO				(LATGbits.LATG4)
#define LED5_TRIS			(TRISGbits.TRISG4)	// Ref D3
#define LED5_IO				(LATGbits.LATG4)
#define LED6_TRIS			(TRISGbits.TRISG4)	// Ref D2
#define LED6_IO				(LATGbits.LATG4)
#define LED7_TRIS			(TRISGbits.TRISG4)	// Ref D1
#define LED7_IO				(LATGbits.LATG4)
#define LED_GET()			(LATG)
#define LED_PUT(a)			(LATG = (a))

// Momentary push buttons
#define BUTTON0_TRIS		(TRISBbits.TRISB4)	// Ref S5
#define	BUTTON0_IO			(PORTBbits.RB4)
#define BUTTON1_TRIS		(TRISBbits.TRISB3)	// Ref S4
#define	BUTTON1_IO			(PORTBbits.RB3)
#define BUTTON2_TRIS		(TRISBbits.TRISB2)	// Ref S3
#define	BUTTON2_IO			(PORTBbits.RB2)
#define BUTTON3_TRIS		(TRISBbits.TRISB1)	// Ref S2
#define	BUTTON3_IO			(PORTBbits.RB1)
